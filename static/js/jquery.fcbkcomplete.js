 ...
 * adapter_matching_properties - match properties for the adapter 
 * input_size       - size of the input element (default: 1)
  ...
  $.fn.fcbkcomplete = function(opt) {
    return this.queue( function() {
      ...
      function addInput(focusme) {
        ...
        var input = $('<input type="text" class="maininput" size="' + options.input_size + '" autocomplete="off">');
        ...
        if (options.input_placeholder != null) input.attr("placeholder", options.input_placeholder);
        ...
        input.keypress( function(event) {
          ...
          //auto expand input
          var newsize = (options.input_size > input.val().length) ? options.input_size : (input.val().length + 1);
          ...
          if (options.cache && json_cache_object.get(etext)) {
            ...
            setTimeout( function() {
              ...
              $.getJSON(options.json_url, {"tag": xssDisplay(etext)}, function(data) {
                ...
                if (options.adapter_matching_properties) { // matching properties
                  for (var idx=0;idx<data.length; idx++) {
                      var adapted = {};
                      var value = null;
                      for (property in options.adapter_matching_properties) {
                        value = data[idx][options.adapter_matching_properties[property]];
                        adapted[property] = isNaN(value)?value:new Number(value).toString();
                      } 
                      data[idx] = adapted;
                  }
                }
      ...
      var options = $.extend({
        ...
        adapter_matching_properties: null
      },
      opt);
