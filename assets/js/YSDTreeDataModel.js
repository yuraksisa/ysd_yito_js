define(['YSDArrayDataModel'], function(ArrayDataModel){
  ...
  /* -----------------------------------------------------------
     ...
     It uses YsdForms.HierarchyListData to adapt the data, which
  ...
  function TreeDataModel() { /* TreeDataModel */
      ...
      this.adaptedData = new YsdForms.HierachyListAdapter(data);      
      this.equivalenceTable = [];
