define(['YSDEventTarget', 'YSDGui', 'YSDForms', 'ysdtemplate', 'jquery', 'YSDjson2'],function(YSDEventTarget, YSDGui, YSDForms, tmpl, $){
  ...
  YSDCommentsView = function(model, controller) { /* The View */
    ...
    this.format_message_date_time = function(comment) { /* format the received date-time */
       ...
       var the_date = comment.date;
    
       var date = Date.parse(the_date);
       var c_date = Date.parse(the_date).clearTime();    
