define(['jquery'], function($) {
  ...
  function YSDPagerPListView(containerElementId, numberOfPages) {
    ...
    this.createButtons = function() {
      ...
      // Create the buttons
      var firstBlockPage = this.model.currentPage;
      var lastBlockPage = this.model.currentPage + numberOfPages;

      for (var idx=firstBlockPage; idx<= lastBlockPage) {
        
        var button = document.createElement('button');
       
        button.setAttribute('class', 'form-button pager-navigation-button');
