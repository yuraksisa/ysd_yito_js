/* jquery plugins used :
     - formparams
 */
define(['jquery', 'YSDEventTarget','YSDGui', 'YSDjson2', 'jquery.formparams'], function($,YSDEventTarget,YSDGui){
  ...
  function EntityModel(urls, entity, pageSize, entityView, entityHooks, dataModel, model_configuration) { /* It represents the model */
    ...
    this.change_state = function(action) {
      ...
      this.configuration.search_params = urlParams;
    ...
    this.query = function() { /* Queries for data */
